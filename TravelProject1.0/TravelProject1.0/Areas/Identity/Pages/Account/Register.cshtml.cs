...
namespace TravelProject1._0.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = " {0} 長度必須至少為 {2} 最長不得超過 {1} ", MinimumLength = 6)]
            ...
            [DataType(DataType.Password)]
            [Display(Name = "密碼確認")]
            [Compare("Password", ErrorMessage = "密碼與重複輸入密碼不相符")]
